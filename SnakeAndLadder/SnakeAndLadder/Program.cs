...
namespace SnakeAndLadder
{
    internal class SnakeAndLadder
    {
        ...
        public static void UC_6_WinGamePositionAfterDieRole()
        {
            int ladder = 1, ldice = 0;
            int snake = 2, sdice;
            int win = 100;
        ...
        public static void UC_7_GameWith2Player()
        {
        ...
        static void Main(string[] args)
        {
            ...
            SnakeAndLadder.UC_6_WinGamePositionAfterDieRole();
            SnakeAndLadder.UC_7_GameWith2Player();
        }
    }
}
